...
| [`chat-hitl`](./docs/components/chat-hitl.md) | `HitlProposalCard` / `FieldDiff` — human-in-the-loop proposal cards: field-level before/after diffs (long text via TextDiffView), approve/reject with armed destructive confirm, pending/approved/rejected/conflict/expired states | [stories](https://neuronection.github.io/assistant-ui/) |
