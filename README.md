...
| [`error-banner`](./docs/components/error-banner.md) / [`undo-notice`](./docs/components/undo-notice.md) / [`empty-state`](./docs/components/empty-state.md) / [`spinner`](./docs/components/spinner.md) / [`skeleton`](./docs/components/skeleton.md) | presentational feedback: alert banner with `action` slot · undo toast · `EmptyState` · `Spinner` · `Skeleton`/`SkeletonText` shimmer placeholders (reduced-motion static) | [stories](https://neuronection.github.io/assistant-ui/?story=feedback--errors) |
