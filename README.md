...
| [`chat-trace-timeline`](./docs/components/chat-trace-timeline.md) | `ChatTraceTimeline` — collapsible per-turn trace: duration-proportional phase/tool bars, tokens, model, reasoning disclosure | [stories](https://neuronection.github.io/assistant-ui/?story=chat-trace-timeline--default) |
